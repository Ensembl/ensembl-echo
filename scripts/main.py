...
from closest_relatives_birds import get_closest_rel_within_cluster
...
def main():
    ...
    if(args.num_of_rel):
        ...
        closest_neighbours = get_closest_rel_within_cluster(args.num_of_rel, args.species_path, args.cluster_path, args.input_pep_files, args.output_dir)
main()